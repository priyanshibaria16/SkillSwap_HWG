...
const upcomingSessions = [
  { id: "s1", skill: "Advanced Pottery", tutor: "Alice W.", date: "2024-08-15", time: "10:00 AM", status: "Confirmed", image: "https://placehold.co/80x80.png", dataAiHint: "pottery class" },
  { id: "s2", skill: "Spanish Conversation", learner: "Self", date: "2024-08-18", time: "02:00 PM", status: "Confirmed", image: "https://placehold.co/80x80.png", dataAiHint: "language study" },
];

const barterRequests = [
  { id: "b1", skillOffered: "Graphic Design Basics", skillRequested: "Yoga for Beginners", fromUser: "Charlie B.", status: "Pending", image: "https://placehold.co/80x80.png", dataAiHint: "graphic design" },
  { id: "b2", skillOffered: "Baking Sourdough", skillRequested: "Introduction to Coding", toUser: "Diana P.", status: "Accepted", image: "https://placehold.co/80x80.png", dataAiHint: "baking bread" },
  { id: "b3", skillOffered: "Guitar Lessons", skillRequested: "Digital Marketing", fromUser: "Edward S.", status: "Declined", image: "https://placehold.co/80x80.png", dataAiHint: "guitar music" },
];
            ...
            {upcomingSessions.length > 0 ? upcomingSessions.map(session => (
              <Card key={session.id} className="shadow-md">
                ...
                <CardContent className="space-y-2">
                  <p className="flex items-center text-sm"><CalendarDays className="mr-2 h-4 w-4 text-muted-foreground" /> {session.date} at {session.time}</p>
              ...
              <Card key={request.id} className="shadow-md">
                ...
                <CardFooter className="gap-2">
                  ...
                  {request.status === "Pending" && request.toUser && (
                     <Button variant="ghost" size="sm"><RefreshCw className="mr-2 h-4 w-4" /> Withdraw</Button>
                  )}
                </CardFooter>
              </Card>
